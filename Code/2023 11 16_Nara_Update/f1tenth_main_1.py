...
class Motion(object):
    ...
    def cycle(self):
        ...
        #for i in images:
            ...
            img=self.img_processing.get_raw_image()
            print('output_img',img)
            curr_found_line,curr_coeff,tranform_img=self.img_processing.line_detection(img)
            err=[]
            ...
            cv2.imshow('hsv_perspective', img)
